...
#include "../../include/engine/MagicNumbers.h"
...
static inline u64 get_archbishop_attacks(const int square, u64 occupancy) {
  return get_bishop_attacks(square, occupancy) | attack_tables.knight_attacks[square];
}

static inline u64 get_chancellor_attacks(const int square, u64 occupancy) {
  return get_rook_attacks(square, occupancy) | attack_tables.knight_attacks[square];
}

static inline u64 get_amazon_attacks(const int square, u64 occupancy) {
  return get_queen_attacks(square, occupancy) | attack_tables.knight_attacks[square];
}
